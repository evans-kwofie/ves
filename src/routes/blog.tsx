...
const getBlogData = createServerFn().handler(async () => {
  await initDb();
  const [posts, keywords] = await Promise.all([listBlogPosts(), listKeywords()]);
  ...
  return (
    <>
      ...
      <div className="page-content">
        <BlogGenerator keywords={keywords} onGenerated={handleGenerated} />
